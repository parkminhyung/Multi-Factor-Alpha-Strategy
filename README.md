...
> **Live testing results for the KRX market using this model are available in the performance section at [https://parkminhyung.github.io](https://parkminhyung.github.io), updated automatically every day. (Live testing is currently available for KRX only.)**
...
> **이 모델을 이용한 라이브테스팅 결과는 [https://parkminhyung.github.io](https://parkminhyung.github.io) 의 performance란에 있으며, 매일 자동으로 업데이트됩니다. (현재 라이브테스팅은 KRX 시장만 운영 중입니다.)**
...
> **本模型的实盘测试结果（仅限KRX市场）可在 [https://parkminhyung.github.io](https://parkminhyung.github.io) 的 performance 栏中查看，每日自动更新。**
...
> **本モデルを使用したライブテスト結果（KRX市場のみ）は、[https://parkminhyung.github.io](https://parkminhyung.github.io) のパフォーマンスセクションでご確認いただけます。毎日自動更新されます。**
